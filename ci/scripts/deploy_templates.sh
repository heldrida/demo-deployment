...
put_secrets_in_parameter_store(){
  aws ssm put-parameter --type "String" --name "/${IMAGE_NAME}/DBNAME" --value "${DBNAME}"
  aws ssm put-parameter --type "SecureString" --name "/${IMAGE_NAME}/DBPASSWORD" --value "${DBPASSWORD}"
  aws ssm put-parameter --type "String" --name "/${IMAGE_NAME}/DBHOST" --value "${DBHOST}"
  aws ssm put-parameter --type "String" --name "/${IMAGE_NAME}/DBUSER" --value "${DBUSER}"
}
